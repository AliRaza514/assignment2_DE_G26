...
# Define updated content metadata with 10 rows
content_metadata = [
    [2000, "Chill Beats", "Lo-Fi", 150, "DJ Smooth"],
    [2001, "Hard Rock Legends", "Rock", 260, "The Thunder"],
    [2002, "Tech Talk Ep 5", "Podcast", 720, "Innovate Hub"],
    [2003, "Global News Now", "News", 850, "World Report"],
    [2004, "Smooth Jazz Evening", "Jazz", 310, "Jazz Masters"],
    [2005, "Hip Hop Evolution", "Hip Hop", 220, "MC Blaze"],
    [2006, "Classical Serenity", "Classical", 430, "Beethoven Ensemble"],
    [2007, "Reggae Rhythms", "Reggae", 340, "Kingston Vibes"],
    [2008, "Trance Energy", "Electronic", 270, "DJ Pulse"],
    [2009, "Indie Melodies", "Indie", 290, "The Strumming Poets"],
]
...
for i in range(days):
    ...
    with open(filename, "w", newline="") as file:
        ...
        for _ in range(random.randint(25, 35)):  # Generate 25-35 rows per day
            ...
            timestamp = (date + random_time).strftime("%Y-%m-%d %H:%M:%S")  
            # Combine date & random time
